...
define i32 @main() {
	...
	label2:
	%25 = phi i1 [ false, %0 ], [ %24, %label1 ]
	%26 = zext i1 %25 to i32
	%27 = icmp ne i32 %26, 0
	br i1 %27, label %label3, label %label4
	...
	label4:
	%30 = phi i1 [ false, %label2 ], [ %29, %label3 ]
	%31 = sitofp i1 %30 to double
	store double %31, double* %b, align 8
